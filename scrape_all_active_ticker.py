...
Only processes records where active = TRUE
"""
...
def run_active_process():
    """Run process for all active tickers"""
    current_time = datetime.now().strftime('%Y-%m-%d %H:%M:%S')
    print(f"Starting active ticker process at {current_time}...\n")
