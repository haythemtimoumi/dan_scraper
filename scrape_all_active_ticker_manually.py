#!/usr/bin/env python
"""
Manual process for target tickers:
...
def run_active_process_manually():
    """Run process for target tickers"""
    current_time = datetime.now().strftime('%Y-%m-%d %H:%M:%S')
    print(f"Starting manual active ticker process at {current_time}...\n")
    ...
    try:
        ...
        for i, (ticker_id, symbol, guru_id, list_type, last_action, per_portfolio) in enumerate(target_tickers, 1):
            ...
            try:
                ...
                # Keep target flag as true for future runs
