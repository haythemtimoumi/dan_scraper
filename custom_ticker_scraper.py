...
def run_custom_scraper(ticker_file, csv_output="fresh_ticker_data.csv", headless=True):
...
if __name__ == "__main__":
    ...
    success = run_custom_scraper(args.ticker_file, args.output, headless=not args.visible)
